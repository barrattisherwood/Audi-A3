...
<body>
  ...
  <tr><td><h2 style="text-transform:uppercase"><?php echo $title ?></h2>A new "New Vehicle" enquiry has been submitted. The details of the person enquiring follow:</td></tr>
  <tr><td>
  ...
  <tr><th bgcolor="#acacac">Make</th><td style="border:solid 1px #999; padding:12px"><?php echo $_make ?></td></tr>
  <tr><th bgcolor="#acacac">Model</th><td style="border:solid 1px #999; padding:12px"><?php echo $_model ?></td></tr>
  <tr><th bgcolor="#acacac">Series</th><td style="border:solid 1px #999; padding:12px"><?php echo $_variant ?></td></tr>
  </table>
