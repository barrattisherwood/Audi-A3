...
<body>
  ...
  <tr><td><h2 style="text-transform:uppercase"><?php echo $title ?></h2>A new online booking has been made. The details of the person booking follow:</td></tr>
  <tr><td>
  
  <table border=0 class="data">
  <tr><th bgcolor="#acacac">Name</th><td style="border:solid 1px #999; padding:12px"><?php echo $name?></td></tr>
  <tr><th bgcolor="#acacac">Email</th><td style="border:solid 1px #999; padding:12px"><?php echo $email?><?php echo $email_verified? '<sup>Verified</sup>':''?></td></tr>
  ...
  <table border=0 class="data">
  <tr><th bgcolor="#acacac">Drop off Date</th><td style="border:solid 1px #999; padding:12px"><?php echo $drop_off_date ?></td></tr>
  <tr><th bgcolor="#acacac">Drop off time</th><td style="border:solid 1px #999; padding:12px"><?php echo $drop_off_time ?></td></tr>
  <tr><th bgcolor="#acacac">Service Type</th><td style="border:solid 1px #999; padding:12px"><?php echo $service_type ?></td></tr>
  <tr><th bgcolor="#acacac">Requires Transport back home or to office</th><td style="border:solid 1px #999; padding:12px"><?php echo $requires_lift ?></td></tr>
  ...
  <tr><th bgcolor="#acacac">Series</th><td style="border:solid 1px #999; padding:12px"><?php echo $series ?></td></tr>
  <tr><th bgcolor="#acacac">Year</th><td style="border:solid 1px #999; padding:12px"><?php echo $year ?></td></tr>
  <tr><th bgcolor="#acacac">Registration Number</th><td style="border:solid 1px #999; padding:12px"><?php echo $reg_number ?></td></tr>
  </table>
