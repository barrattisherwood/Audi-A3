...
<body>
  ...
  <tr><td><h2 style="text-transform:uppercase"><?php echo $title ?></h2>A new parts enquiry has been submitted. The details of the person enquiring follow:</td></tr>
  <tr><td>
  ...
  <table border=0 class="data">
  <tr><th bgcolor="#acacac">Part Number(s)</th><td style="border:solid 1px #999; padding:12px"><?php echo $part_number ?></td></tr>
