...
<body>
  ...
  <tr><td><h2 style="text-transform:uppercase"><?php echo $title ?></h2>A new website form submission has been made. The details of the enquirer follow:</td></tr>
  <tr><td>
  ...
  <tr><td>Below are the specifics of the enquiry:</td></tr>
  <tr><td>
  
  <table border=0 class="data">
  <tr><th bgcolor="#acacac">Message or Enquiry</th><td style="border:solid 1px #999; padding:12px"><div style='font-family:Georgia,Times;font-style:italic;color:#999'><?php echo $message?></div></td></tr>
  </table>
  ...
  <table border=0 class="data">
  <tr><th bgcolor="#acacac" style='color:#999;font-style:italic'>IP</th><td style='color:#acacac;font-style:italic'><?php echo $_SERVER['REMOTE_ADDR']?></td></tr>
  <tr><th bgcolor="#acacac" style='color:#999;font-style:italic'>Useragent</th><td style='color:#acacac;font-style:italic'><?php echo $_SERVER['HTTP_USER_AGENT']?></td></tr>
  <tr><th bgcolor="#acacac" style='color:#999;font-style:italic'>Referer</th><td style='color:#acacac;font-style:italic'><?php echo $_SERVER['HTTP_REFERER']?></td></tr>
  </table>
