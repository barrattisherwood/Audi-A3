    ...
    SEMICOLON.initialize = {
        ...
        goToTopScroll: function(){
            if( $body.hasClass('device-lg') || $body.hasClass('device-md') || $body.hasClass('device-sm') ) {
                ...
                var bottomOffset = $(document).height() - 400;   

                console.log('Scroll bottom: '+scrollBottom);
                console.log('Bottom offest: '+bottomOffset);

                if(scrollBottom > bottomOffset) {
                    console.log("bottom");
                    $goToTopEl.addClass('upped');
                } else {
                    console.log("not bottom");
                    $goToTopEl.removeClass('upped');
                }              
...
$(document).ready(function(){
    ...
    $('.click-cover').click(function(event){
        event.preventDefault();
        $(this).hide();
    });

    $('.click-cover#click-arcadia').click(function(event){
        event.preventDefault();
        ga('send', 'event', 'Call Button Audi Arcadia', 'Click to call', 'McCarthy A3 Landing Page');        
    });    

    $('.click-cover#click-menlyn').click(function(event){
        event.preventDefault();
        ga('send', 'event', 'Call Button Audi Menlyn', 'Click to call', 'McCarthy A3 Landing Page');        
    });

    $('.click-cover#click-west-rand').click(function(event){
        event.preventDefault();
        ga('send', 'event', 'Call Button Audi West Rand', 'Click to call', 'McCarthy A3 Landing Page');
    });     

    $('.click-cover#click-middelburg').click(function(event){
        event.preventDefault();
        ga('send', 'event', 'Call Button Audi Middelburg', 'Click to call', 'McCarthy A3 Landing Page');
    });      

    $('.click-cover#click-durban').click(function(event){
        event.preventDefault();
        ga('send', 'event', 'Call Button Audi Durban', 'Click to call', 'McCarthy A3 Landing Page');
    });        

    $('.click-cover#click-umhlanga').click(function(event){
        event.preventDefault();
        ga('send', 'event', 'Call Button Audi Umhlanga', 'Click to call', 'McCarthy A3 Landing Page');
    });      

    $('.click-cover#click-wonderboom').click(function(event){
        event.preventDefault();
        ga('send', 'event', 'Call Button Audi Wonderboom', 'Click to call', 'McCarthy A3 Landing Page');
    });         
